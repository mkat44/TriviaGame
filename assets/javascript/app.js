...
$(".text").html("<h3>A Quiz of Quotes</h3><br>");
$(".text").html("<br><br>Name the character who said the quote to get a point! Take the quiz again and again to improve your score!");
$(".timerrow").hide()
...
$(document).on("click", "start-button", function() {
    ...
    function countdown() {
        if (timer == -1) {
            ...
            $(".timerbox").html(lifesupport + " seconds...");
            currenttimer--;
            }
    }
    for (i = 0; i < questionarray.length; i++) {
        ...
        $(".question-area").html(currentquestion.quote);
